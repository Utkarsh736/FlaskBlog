...
@app.route("/account", methods=['GET', 'POST']) # Account route
@login_required
def account():
    form = UpdateAccountForm()

    # Profile Pic validator
    if form.validate_on_submit():
...
@app.route("/post/new", methods=['GET', 'POST'])     # New Post route
@login_required
def new_post():
    form = PostForm()
    if form.validate_on_submit():
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
                    sender='utkarshtomar736@gmail.com',
